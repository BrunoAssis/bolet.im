  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved period as @period" do
        ...
        post :create, {:period => { "school" => "invalid value" }}, valid_session
        assigns(:period).should be_a_new(Period)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested period" do
        ...
        Period.any_instance.should_receive(:update).with({ "school" => "" })
        put :update, {:id => period.to_param, :period => { "school" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the period as @period" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Period.any_instance.stub(:save).and_return(false)
        put :update, {:id => period.to_param, :period => { "school" => "invalid value" }}, valid_session
        assigns(:period).should eq(period)
      end
